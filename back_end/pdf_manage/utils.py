...
class RL_Codecs:
    ...
    def _makeCodecInfo(name,encoding_map,decoding_map):
        ...
        class Codec(codecs.Codec):
            def encode(self,input,errors='ignore',charmap_encode=codecs.charmap_encode,encoding_map=encoding_map):
                return charmap_encode(input,errors,encoding_map)

            def decode(self,input,errors='ignore',charmap_decode=codecs.charmap_decode,decoding_map=decoding_map):
    ...
    def _rl_codecs(name):
        ...
        if name == 'extpdfdoc' : return RL_Codecs.__rl_codecs('extpdfdoc')
